...
public class Md5EncryptorTests
{
    ...
    [Fact]
    public void EncryptDecryptManualTest()
    {
        var _encryptor = new Md5Encryptor("my-key");

        var _expected = "hobaa";

        var _encrypted = _encryptor.Encrypt(_expected);

        var _decrypted = _encryptor.Decrypt(_encrypted);
